...
local Window = Libary:MakeWindow({
    ...
    SubTitle = "by: nercas and herry",
    LoadText = "Carregando dog hub",
    Flags = "Doghub_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://131671210128637", BackgroundTransparency = 0 },
...
InfoTab:AddParagraph({ "Owner / Developer:", "nercas and herry." })
InfoTab:AddParagraph({ "Colaborações:", "herry" })
InfoTab:AddParagraph({ "Você está usando:", "Dog Hub Brookhaven " })
...
local names = {
    {"NullByte", " NullByte "},
    {"GhostX", " GhostX "},
    {"ERR0R404DESTROY", " ERR0R404DESTROY "},
    {"DARKER", " DARKER "},
    {"GHOST", " GHOST "},
    {"JOKER", " JOKER "},
    {"ADMIN", " ADMIN "},
    {"TUBERS93", " TUBERS93 "},
    {"CO0LKID", " CO0LKID "},
    {"GAME ATTACKED BY MÁFIA", " GAME ATTACKED BY MAFIA "},
    {"INC0MUN", " INC0MMUN"},
    {"SAD BOY", " SAD BOY "}
}
